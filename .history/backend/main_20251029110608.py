...
# Get MongoDB URI and handle authentication if present
MONGODB_URI = os.getenv("MONGODB_URI", "mongodb://localhost:27017")
if '@' in MONGODB_URI:
    # If URI contains authentication, we need to encode username and password
    prefix = MONGODB_URI[:MONGODB_URI.find("://") + 3]
    rest = MONGODB_URI[MONGODB_URI.find("://") + 3:]
    ...
    # Reconstruct the URI
    MONGODB_URI = f"{prefix}{encoded_username}:{encoded_password}@{host}"
